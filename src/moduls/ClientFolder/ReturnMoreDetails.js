...
class ReturnMoreDetail extends Component
{
    constructor(props)
    {
        super(props);
              ...
              <div className="col-xl-10 col-md-12 col-sm-12  mainBar">
                ...
                <div className="container-fluid">
                    ...
                    <div className="row inMobileView">
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12" style={{marginTop: "2%"}}>
                                
                                <div className="inMobileViewButton">
                                {/* <Link to={`/ShowInvoice/${this.state.delAddressID}pro${this.state.customerID}pro${this.state.orderID}`}  className="OrderButtions" style={{textDecoration : "none",color:"white"}}>Download Invoice</Link> */}
                                <button className="OrderButtions" onClick={this.downloadInvoice}>Download Invoice</button>
                                </div>
                        ...
                        <button className="OrderButtions inMobileViewButton" onClick={this.getCustomerAddress}>Delivery Address</button>
                        </div>
                        ...
                        <button className="OrderButtions inMobileViewButton" onClick={this.getCustomerDetails}>Customer Details</button>
                        </div>


                            
                        <div className="col-xl-1 col-lg-2 col-md-12 col-sm-12">

                            <div style={{marginTop : "30px"}} className="lastButton">
                            <Link className="OrderButtions back" style={{textDecoration : "none", color:"white"}} to="/NewOrder"> Back </Link>
                            </div>
...
export default ReturnMoreDetail;