                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <h5 style={{marginTop : "2%"}}>Return Orders </h5>
...

                                        {
                                            this.state.tableData.map((user,index)=>(
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td><Link to={`/ReturnMoreDetail/${user.delID}pro${user.customerID}pro${user.orderID}`}><img src={moreDatails} className="buttonLogo" title="Edit" /></Link></td>
