...
class AllCustomerInfo extends Component
{
    constructor(props)
    {
        super(props);
    ...
    componentDidMount()
    {
        ...
        if(this.state.checkLoginStatus == true)
        {
            ...
            axios.post(`${process.env.REACT_APP_API_URL_BACKEND_CALL}/getTotalCustomerInfo`,{productTable : productTable }
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <h5 style={{marginTop : "2%"}}>All Customer Details </h5>
...

                                        {
                                            this.state.tableData.map((user,index)=>(
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>{user.cMobile}</td>
                                                    <td>{user.cGender}</td>
                                                    <td>{user.cCity } {user.cState} {user.cCountry} {user.cPincode} {}</td>
...
export default AllCustomerInfo;