...
const ChnagePassword = (props)=>
{
   ...
   // console.log("Chnage Password page ",token);
    ...
    if(token == null || token == "")
    {
        history.push("/ForgotCustomerPassword");
    }
...
<div className="login card">
  ...
  <div className="row">
        ...
        <p className="LoginButton"><input type="submit" name="commit" value="Submit"  className="placeOrder"/></p>
  ...
  <button className="placeOrder" style={{marginTop : "20px"}} onClick={handleModalPasss}><FontAwesomeIcon icon={faPhone} />&nbsp;&nbsp;&nbsp;&nbsp;Support</button>
</div>
